  ...
  const onSubmit = async () => {
    ...
    return (
      <div dir="rtl" className="relative ">
        <div className="flex flex-col justify-center items-center mt-20 bg-lime-200 py-8 rounded-xl">
          <div>
            <h2 className="text-5xl text-center text-sky-500">
        ...
        {/* <div className="absolute top-20 left-0 w-[300px]">
          <img src={tuktuk} />
        </div> */}
      </div>
    );
